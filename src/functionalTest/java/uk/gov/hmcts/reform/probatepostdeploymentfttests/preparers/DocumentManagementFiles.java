package uk.gov.hmcts.reform.probatepostdeploymentfttests.preparers;

import io.restassured.http.Headers;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.core.io.Resource;
import org.springframework.stereotype.Component;
import uk.gov.hmcts.reform.probatepostdeploymentfttests.domain.entities.documents.Document;
import uk.gov.hmcts.reform.probatepostdeploymentfttests.domain.entities.documents.DocumentNames;
...
import uk.gov.hmcts.reform.probatepostdeploymentfttests.util.BinaryResourceLoader;
...
public class DocumentManagementFiles implements Preparer {
    ...
    public Document uploadDocument(DocumentNames document) {
        ...
        if (maybeResource.isPresent()) {
            ...
            Headers headers = authorizationHeadersProvider.getProbateSystemUserAuthorization();
